          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center justify-between mb-5">
                ...
                <a href="/offres" className="text-xs text-pink hover:underline font-medium">Voir tout</a>
              </div>
                      ...
                      <div className="flex gap-0.5" aria-label={`${rating} étoiles`}>
                        {Array.from({ length: 5 }).map((_, i) => (
                          <Star
                            key={i}
                            size={11}
                            className={i < rating ? 'fill-yellow text-yellow' : 'fill-gray-200 text-gray-200'}
                          />
                        ))}
                      </div>
                    </div>
